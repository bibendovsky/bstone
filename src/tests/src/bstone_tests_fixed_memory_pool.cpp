...
{
	using Item = double;
	using MemoryPool = bstone::FixedMemoryPool<Item, 1>;
...
private:
	...
	{
		tester.register_test("FixedMemoryPool#nrkmtbnuex9y6k5e", test_nrkmtbnuex9y6k5e);
		tester.register_test("FixedMemoryPool#9v82vg27zs4781w5", test_9v82vg27zs4781w5);
		tester.register_test("FixedMemoryPool#uyubiuemn20zxum3", test_uyubiuemn20zxum3);
	}
};
