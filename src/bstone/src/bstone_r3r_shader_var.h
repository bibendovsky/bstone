...
public:
	...
	virtual R3rShaderVarType get_type() const = 0;
	virtual R3rShaderVarTypeId get_type_id() const = 0;
	virtual int get_index() const = 0;
	virtual const std::string& get_name() const = 0;

	virtual void set_int32(int32_t value) = 0;
	virtual void set_float32(float value) = 0;
	virtual void set_vec2(const float* value) = 0;
	virtual void set_vec3(const float* value) = 0;
	virtual void set_vec4(const float* value) = 0;
	virtual void set_mat4(const float* value) = 0;
	virtual void set_r2_sampler(int32_t value) = 0;
};
