...
{
	using SdlPrefPathUPtr = std::unique_ptr<char[], Sdl3PrefPathDeleter>;
	const auto sdl_path = SdlPrefPathUPtr{sdl3_ensure_result(SDL_GetPrefPath(organization_name, application_name))};
