...
#ifndef BSTONE_SYS_WINDOW_SDL3_INCLUDED
#define BSTONE_SYS_WINDOW_SDL3_INCLUDED
...
class Sdl3WindowInternal : public Window
{
public:
	Sdl3WindowInternal();
	~Sdl3WindowInternal() override;
...
#endif // BSTONE_SYS_WINDOW_SDL3_INCLUDED
