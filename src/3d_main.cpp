...
#ifdef __vita__
    //todo: replace all this with hardcoded values for psvita screen dimensions
    ::vga_3d_view_top = (::ref_3d_view_top * ::vga_height) / ::vga_ref_height + 1;
    ::vga_3d_view_bottom = (::ref_3d_view_bottom * ::vga_height) / ::vga_ref_height + 1;
#else
