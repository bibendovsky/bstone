...
//
extern char QuitMsg[];
#define JM_ERROR(Unit, Error) Quit(QuitMsg, Unit, Error)

#define IO_ERROR(Error) JM_ERROR(JM_IO_ERROR, Error)
#define TP_ERROR(Error) JM_ERROR(JM_TP_ERROR, Error)
#define AN_ERROR(Error) JM_ERROR(JM_AN_ERROR, Error)

#define MAIN_ERROR(Error) JM_ERROR(D3_MAIN_ERROR, Error)
#define STATE_ERROR(Error) JM_ERROR(D3_STATE_ERROR, Error)
#define DEBUG_ERROR(Error) JM_ERROR(D3_DEBUG_ERROR, Error)
#define PLAY_ERROR(Error) JM_ERROR(D3_PLAY_ERROR, Error)
#define ACT1_ERROR(Error) JM_ERROR(D3_ACT1_ERROR, Error)
#define ACT2_ERROR(Error) JM_ERROR(D3_ACT2_ERROR, Error)
#define GAME_ERROR(Error) JM_ERROR(D3_GAME_ERROR, Error)
#define AGENT_ERROR(Error) JM_ERROR(D3_AGENT_ERROR, Error)
#define SCALE_ERROR(Error) JM_ERROR(D3_SCALE_ERROR, Error)
#define US1_ERROR(Error) JM_ERROR(ID_US1_ERROR, Error)
#define IN_ERROR(Error) JM_ERROR(ID_IN_ERROR, Error)
#define CA_ERROR(Error) JM_ERROR(ID_CA_ERROR, Error)
#define PM_ERROR(Error) JM_ERROR(ID_PM_ERROR, Error)
#define VH_ERROR(Error) JM_ERROR(ID_VH_ERROR, Error)
#define SD_ERROR(Error) JM_ERROR(ID_SD_ERROR, Error)
#define MM_ERROR(Error) JM_ERROR(ID_MM_ERROR, Error)
#define DRAW2_ERROR(Error) JM_ERROR(DRAW2_ERROR, Error)
#define MENU_ERROR(Error) JM_ERROR(MENU_ERROR, Error)
