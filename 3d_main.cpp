...
int TELEPORT_LUMP_START = 0;
int TELEPORT_LUMP_END = 0;

int README_LUMP_START = 0;
int README_LUMP_END = 0;

int CONTROLS_LUMP_START = 0;
int CONTROLS_LUMP_END = 0;

int LATCHPICS_LUMP_START = 0;
int LATCHPICS_LUMP_END = 0;
...
int TELEPORTBACKPIC = 0;
int TELEPORT1OFFPIC = 0;
int TELEPORT2OFFPIC = 0;
int TELEPORT3OFFPIC = 0;
int TELEPORT4OFFPIC = 0;
int TELEPORT5OFFPIC = 0;
int TELEPORT6OFFPIC = 0;
int TELEPORT7OFFPIC = 0;
int TELEPORT8OFFPIC = 0;
int TELEPORT9OFFPIC = 0;
int TELEPORT10OFFPIC = 0;
int TELEPORT1ONPIC = 0;
int TELEPORT2ONPIC = 0;
int TELEPORT3ONPIC = 0;
int TELEPORT4ONPIC = 0;
int TELEPORT5ONPIC = 0;
int TELEPORT6ONPIC = 0;
int TELEPORT7ONPIC = 0;
int TELEPORT8ONPIC = 0;
int TELEPORT9ONPIC = 0;
int TELEPORT10ONPIC = 0;
int TELEPORT_TEXT_BG = 0;
int BACKGROUND_SCREENPIC = 0;
int APOGEEPIC = 0;
int PIRACYPIC = 0;
int PC13PIC = 0;
int LOSEPIC = 0;
...
int H_LPIC = 0;
int H_SHIFTPIC = 0;
int APOGEE_LOGOPIC = 0;
int VISAPIC = 0;
int MCPIC = 0;
int FAXPIC = 0;
int H_TOPWINDOWPIC = 0;
int H_LEFTWINDOWPIC = 0;
int H_RIGHTWINDOWPIC = 0;
int H_BOTTOMINFOPIC = 0;
int C_NOTSELECTEDPIC = 0;
int C_SELECTEDPIC = 0;
int C_NOTSELECTED_HIPIC = 0;
int C_SELECTED_HIPIC = 0;
int C_BABYMODEPIC = 0;
int C_EASYPIC = 0;
int C_NORMALPIC = 0;
int C_HARDPIC = 0;
...
int C_EPISODE5PIC = 0;
int C_EPISODE6PIC = 0;
int BIGGOLDSTERNPIC = 0;
int STARLOGOPIC = 0;
int BLAKEWITHGUNPIC = 0;
int STARINSTITUTEPIC = 0;
int MEDALOFHONORPIC = 0;
int SMALLGOLDSTERNPIC = 0;
int BLAKEWINPIC = 0;
int SHUTTLEEXPPIC = 0;
int PLANETSPIC = 0;
int MOUSEPIC = 0;
...
int DIM_LIGHTPIC = 0;
int BRI_LIGHTPIC = 0;
int ECG_HEART_GOOD = 0;
int ECG_HEART_BAD = 0;
int ECG_GRID_PIECE = 0;
int ECG_HEARTBEAT_00 = 0;
int ECG_HEARTBEAT_01 = 0;
int ECG_HEARTBEAT_02 = 0;
int ECG_HEARTBEAT_03 = 0;
int ECG_HEARTBEAT_04 = 0;
int ECG_HEARTBEAT_05 = 0;
int ECG_HEARTBEAT_06 = 0;
int ECG_HEARTBEAT_07 = 0;
int ECG_HEARTBEAT_08 = 0;
int ECG_HEARTBEAT_09 = 0;
int ECG_HEARTBEAT_10 = 0;
int ECG_HEARTBEAT_11 = 0;
int ECG_HEARTBEAT_12 = 0;
int ECG_HEARTBEAT_13 = 0;
int ECG_HEARTBEAT_14 = 0;
int ECG_HEARTBEAT_15 = 0;
int ECG_HEARTBEAT_16 = 0;
int ECG_HEARTBEAT_17 = 0;
int ECG_HEARTBEAT_18 = 0;
int ECG_HEARTBEAT_19 = 0;
int ECG_HEARTBEAT_20 = 0;
int ECG_HEARTBEAT_21 = 0;
int ECG_HEARTBEAT_22 = 0;
int ECG_HEARTBEAT_23 = 0;
int ECG_HEARTBEAT_24 = 0;
int ECG_HEARTBEAT_25 = 0;
int ECG_HEARTBEAT_26 = 0;
int ECG_HEARTBEAT_27 = 0;
int INFOAREAPIC = 0;
int TOP_STATUSBARPIC = 0;
int STATUSBARPIC = 0;
int PIRACYPALETTE = 0;
int APOGEEPALETTE = 0;
int TITLEPALETTE = 0;
int ORDERSCREEN = 0;
int ERRORSCREEN = 0;
int INFORMANT_HINTS = 0;
int NICE_SCIE_HINTS = 0;
int MEAN_SCIE_HINTS = 0;
int BRIEF_W1 = 0;
int BRIEF_I1 = 0;
int BRIEF_W2 = 0;
int BRIEF_I2 = 0;
...
int CREDITSTEXT = 0;
int MUSTBE386TEXT = 0;
int QUICK_INFO1_TEXT = 0;
int QUICK_INFO2_TEXT = 0;
int BADINFO_TEXT = 0;
int CALJOY1_TEXT = 0;
int CALJOY2_TEXT = 0;
int READTHIS_TEXT = 0;
...
int FLOORMSG_TEXT = 0;
int YOUWIN_TEXT = 0;
int CHANGEVIEW_TEXT = 0;
int DIZ_ERR_TEXT = 0;
int BADLEVELSTEXT = 0;
int BADSAVEGAME_TEXT = 0;

int TELEPORTBACKTOPPIC = 0;
int TELEPORTBACKBOTPIC = 0;
int TELEPORT11ONPIC = 0;
int TELEPORT12ONPIC = 0;
int TELEPORT13ONPIC = 0;
int TELEPORT14ONPIC = 0;
int TELEPORT15ONPIC = 0;
int TELEPORT16ONPIC = 0;
int TELEPORT17ONPIC = 0;
int TELEPORT18ONPIC = 0;
int TELEPORT19ONPIC = 0;
int TELEPORT20ONPIC = 0;
int TELEUPONPIC = 0;
int TELEDNONPIC = 0;
int TELEUPOFFPIC = 0;
int TELEDNOFFPIC = 0;
int TELEPORT11OFFPIC = 0;
int TELEPORT12OFFPIC = 0;
int TELEPORT13OFFPIC = 0;
int TELEPORT14OFFPIC = 0;
int TELEPORT15OFFPIC = 0;
int TELEPORT16OFFPIC = 0;
int TELEPORT17OFFPIC = 0;
int TELEPORT18OFFPIC = 0;
int TELEPORT19OFFPIC = 0;
int TELEPORT20OFFPIC = 0;
int AUTOMAP_MAG1PIC = 0;
int AUTOMAP_MAG2PIC = 0;
int AUTOMAP_MAG4PIC = 0;
int H_6PIC = 0;
int H_TILDEPIC = 0;
int H_PLUSPIC = 0;
int H_MINUSPIC = 0;
int STARPORTPIC = 0;
int BOSSPIC = 0;
int THREEPLANETSPIC = 0;
int SOLARSYSTEMPIC = 0;
int AOGENDINGPIC = 0;
int GFLOGOSPIC = 0;
int BLAKEHEADPIC = 0;
int PROJECTFOLDERPIC = 0;
int TITLE1PIC = 0;
int TITLE2PIC = 0;
int WEAPON6PIC = 0;
int WEAPON7PIC = 0;
...
void initialize_gfxv_contants()
{
    if (::is_aog_full()) {
        ...
        README_LUMP_START = 60;
        README_LUMP_END = 106;

        CONTROLS_LUMP_START = 79;
        CONTROLS_LUMP_END = 92;

        LATCHPICS_LUMP_START = 106;
        LATCHPICS_LUMP_END = 164;
        ...
        TELEPORT_LUMP_END = TELEPORT10ONPIC;
        ...
        TELEPORT_LUMP_START = 8;
        TELEPORT_LUMP_END = 51;

        README_LUMP_START = 60;
        README_LUMP_END = 108;

        CONTROLS_LUMP_START = 109;
        CONTROLS_LUMP_END = 122;

        LATCHPICS_LUMP_START = 145;
        LATCHPICS_LUMP_END = 197;
